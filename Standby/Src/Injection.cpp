	...
	*/
	...
	LPVOID MapDll_ManualMapping()
	{
		...
		static const BYTE ManualMappingShellcodeBytes[] =
			"\x48\x89\x4C\x24\x08\x53\x55\x57\x41\x57\x48\x83\xEC\x38\x48\x8B\x59\x18\x4C\x8B"
			"\xC9\x44\x8B\xDB\x48\x89\x74\x24\x78\x48\x63\x6B\x3C\x48\x03\xEB\x48\x89\x6C\x24"
			"\x70\x44\x2B\x5D\x30\x0F\x84\xA0\x00\x00\x00\x8B\x85\xB4\x00\x00\x00\x85\xC0\x0F"
			"\x84\x92\x00\x00\x00\x44\x8B\x8D\xB0\x00\x00\x00\x4C\x03\xCB\xC1\xE8\x03\x85\xC0"
			"\x74\x7C\x8B\xF8\xBE\xFF\x0F\x00\x00\x0F\x1F\x80\x00\x00\x00\x00\x41\x8B\x41\x04"
			"\x4D\x8D\x41\x08\x48\x83\xE8\x08\x48\xD1\xE8\x85\xC0\x74\x4E\x44\x8B\xD0\x66\x66"
			"\x0F\x1F\x84\x00\x00\x00\x00\x00\x41\x0F\xB7\x00\x0F\xB7\xC8\x66\x23\xC6\x66\xC1"
			...
			"\x48\x83\xEF\x01\x75\x92\x4C\x8B\x4C\x24\x60\x45\x33\xFF\x44\x39\xBD\x94\x00\x00"
			"\x00\x0F\x84\xCA\x00\x00\x00\x4C\x89\x64\x24\x30\x41\x8B\xC7\x4C\x89\x6C\x24\x28"
			"\x4C\x89\x74\x24\x20\x8B\xBD\x90\x00\x00\x00\x48\x03\xF8\x48\x89\x44\x24\x68\x48"
			"\x03\xFB\x83\x3F\x00\x75\x0A\x83\x7F\x10\x00\x0F\x84\x89\x00\x00\x00\x8B\x4F\x0C"
			"\x49\x8B\x01\x48\x03\xCB\xFF\xD0\x8B\x0F\x48\x8B\xE8\x8B\x57\x10\x85\xC9\x41\x8B"
			"\xF7\x4C\x8D\x24\x1A\x0F\x45\xD1\x48\x8B\x0C\x1A\x4D\x8B\xF4\x4C\x8D\x2C\x1A\x48"
			"\x85\xC9\x74\x42\x49\x8B\xFF\x4C\x8B\x7C\x24\x60\x0F\x1F\x40\x00\x49\x8B\x47\x08"
			"\x48\x85\xC9\x79\x05\x0F\xB7\xD1\xEB\x07\x48\x8D\x53\x02\x48\x03\xD1\x48\x8B\xCD"
			"\xFF\xD0\x49\x89\x06\x48\x83\xC7\x08\xFF\xC6\x48\x63\xC6\x4A\x8B\x0C\x2F\x4D\x8D"
			"\x34\xC4\x48\x85\xC9\x75\xCD\x45\x33\xFF\x48\x8B\x44\x24\x68\x4C\x8B\x4C\x24\x60"
			"\x48\x83\xC0\x14\x48\x8B\x6C\x24\x70\xE9\x57\xFF\xFF\xFF\x4C\x8B\x6C\x24\x28\x4C"
			"\x8B\x64\x24\x30\x4C\x8B\x74\x24\x20\x8B\x85\xA4\x00\x00\x00\x48\x8B\x74\x24\x78"
			"\x85\xC0\x74\x23\x8B\xC8\x4C\x8B\xC3\x48\xB8\xAB\xAA\xAA\xAA\xAA\xAA\xAA\xAA\x48"
			"\xF7\xE1\x8B\x8D\xA0\x00\x00\x00\x48\xC1\xEA\x03\x48\x03\xCB\x41\xFF\x51\x10\x83"
			"\xBD\xD4\x00\x00\x00\x00\x74\x37\x8B\xBD\xD0\x00\x00\x00\x48\x8B\x44\x1F\x18\x4C"
			"\x8B\x08\x4D\x85\xC9\x74\x24\x0F\x1F\x44\x00\x00\x45\x33\xC0\x48\x8B\xCB\x41\x8D"
			"\x50\x01\x41\xFF\xD1\x48\x8B\x44\x1F\x18\x4D\x8D\x7F\x08\x4D\x8B\x0C\x07\x4D\x85"
			"\xC9\x75\xE1\x8B\x45\x28\x45\x33\xC0\x48\x03\xC3\x48\x8B\xCB\x41\x8D\x50\x01\x48"
			"\x83\xC4\x38\x41\x5F\x5F\x5D\x5B\x48\xFF\xE0";
#else
		static const BYTE ManualMappingShellcodeBytes[] =
			"\x55\x8B\xEC\x83\xEC\x18\x8B\x55\x08\x53\x56\x57\x8B\x7A\x08\x8B\xC7\x89\x7D\xF4"
			"\x8B\x4F\x3C\x03\xCF\x89\x4D\xFC\x2B\x41\x34\x89\x45\xF8\x0F\x84\x9E\x00\x00\x00"
			"\x8B\x81\xA4\x00\x00\x00\x85\xC0\x0F\x84\x90\x00\x00\x00\x8B\xB1\xA0\x00\x00\x00"
			"\xC1\xE8\x03\x03\xF7\x89\x45\xF0\x85\xC0\x74\x7E\x0F\x1F\x84\x00\x00\x00\x00\x00"
			"\x8B\x5E\x04\x8D\x4E\x04\x83\xEB\x08\x89\x4D\xEC\xD1\xEB\xBA\x00\x00\x00\x00\x74"
			"\x51\x66\x66\x66\x0F\x1F\x84\x00\x00\x00\x00\x00\x0F\xB7\x44\x56\x08\x66\x8B\xC8"
			"\x25\xFF\x0F\x00\x00\x66\xC1\xE9\x0C\x80\xF9\x03\x75\x0D\x8D\x0C\x07\x8B\x06\x8B"
			"\x7D\xF8\x01\x3C\x01\xEB\x15\x80\xF9\x0A\x75\x13\x8D\x0C\x07\x8B\x06\x8B\x7D\xF8"
			"\x01\x3C\x01\x83\x54\x01\x04\x00\x8B\x7D\xF4\x42\x3B\xD3\x72\xC0\x8B\x45\xF0\x8B"
			"\x4D\xEC\x03\x31\x83\xE8\x01\x89\x45\xF0\x75\x90\x8B\x55\x08\x8B\x4D\xFC\x83\xB9"
			"\x84\x00\x00\x00\x00\x0F\x84\x97\x00\x00\x00\x8B\xC7\x89\x7D\xF4\x0F\x1F\x84\x00"
			"\x00\x00\x00\x00\x8B\xB1\x80\x00\x00\x00\x03\xF0\x83\x3E\x00\x75\x06\x83\x7E\x10"
			"\x00\x74\x77\x8B\x4E\x0C\x8B\x02\x03\xCF\x51\xFF\xD0\x8B\x56\x10\x8B\x0E\x85\xC9"
			"\x89\x45\xEC\x8D\x04\x3A\x0F\x45\xD1\x8D\x0C\x3A\x89\x45\xF8\x89\x45\xF0\x8B\x01"
			"\x89\x4D\xE8\x85\xC0\x74\x37\x8B\x5D\xEC\x33\xF6\x8B\x4D\x08\x8B\x49\x04\x85\xC0"
			"\x79\x05\x0F\xB7\xC0\xEB\x05\x83\xC0\x02\x03\xC7\x50\x53\xFF\xD1\x8B\x4D\xF0\x83"
			"\xC6\x04\x8B\x55\xF8\x03\xD6\x89\x55\xF0\x89\x01\x8B\x45\xE8\x8B\x04\x06\x85\xC0"
			"\x75\xCE\x8B\x45\xF4\x8B\x55\x08\x83\xC0\x14\x8B\x4D\xFC\x89\x45\xF4\xE9\x76\xFF"
			"\xFF\xFF\x83\xB9\xC4\x00\x00\x00\x00\x74\x2A\x8B\x99\xC0\x00\x00\x00\x8B\x44\x3B"
			"\x0C\x8B\x00\x85\xC0\x74\x1A\x33\xF6\x6A\x00\x6A\x01\x57\xFF\xD0\x8B\x44\x3B\x0C"
			"\x8D\x76\x04\x8B\x04\x06\x85\xC0\x75\xEB\x8B\x4D\xFC\x8B\x41\x28\x6A\x00\x6A\x01"
			"\x57\x03\xC7\xFF\xD0\x5F\x5E\x5B\x8B\xE5\x5D\xC3";
#endif
...
#ifdef _WIN64
		ScPass.fRtlAddFunctionTable = reinterpret_cast<FRTLADDFUNCTIONTABLE>(GetProcAddress(GetModuleHandleA("NTDLL.DLL"), "RtlAddFunctionTable"));
#endif
	...
	VOID MapDll_ManualMapping_Shellcode(ManualMappingScParams* pScParams)
	{
		...
		if (Offset && pVOptHeader->DataDirectory[IMAGE_DIRECTORY_ENTRY_BASERELOC].Size)
		{
			...
			PIMAGE_BASE_RELOCATION pBaseReloc = reinterpret_cast<PIMAGE_BASE_RELOCATION>((BYTE*)pVDosHeader + pVOptHeader->DataDirectory[IMAGE_DIRECTORY_ENTRY_BASERELOC].VirtualAddress);
		...
		if (pImportDataDir->Size)
		{
			for (int i = 0; ; i++)
			{
				...
				if (!pImportIdx->OriginalFirstThunk && !pImportIdx->FirstThunk)
					break;

				PCHAR ModName = reinterpret_cast<PCHAR>((BYTE*)pVDosHeader + pImportIdx->Name);
				HMODULE hMod = pScParams->fLoadLibraryA(ModName);

				PIMAGE_THUNK_DATA pFirstThunk = reinterpret_cast<PIMAGE_THUNK_DATA>((BYTE*)pVDosHeader + pImportIdx->FirstThunk);
				PIMAGE_THUNK_DATA pThunkIdx = reinterpret_cast<PIMAGE_THUNK_DATA>((BYTE*)pVDosHeader + pImportIdx->OriginalFirstThunk);

				if (pImportIdx->OriginalFirstThunk == 0)
				{
					pThunkIdx = pFirstThunk;
				}

				for (int i2 = 0; ; i2++)
				{
					PIMAGE_THUNK_DATA pIdxFirstThunk = &pFirstThunk[i2];
					PIMAGE_THUNK_DATA pIdxThunkIdx = &pThunkIdx[i2];

					if (!pIdxThunkIdx->u1.AddressOfData)
						break;

					if (IMAGE_SNAP_BY_ORDINAL(pIdxThunkIdx->u1.Ordinal))
					{
						pIdxFirstThunk->u1.Function = pScParams->fGetProcAddress(hMod, (LPCSTR)IMAGE_ORDINAL(pIdxThunkIdx->u1.Ordinal));
					}
					else
					{
						PIMAGE_IMPORT_BY_NAME pName = reinterpret_cast<PIMAGE_IMPORT_BY_NAME>((BYTE*)pVDosHeader + pIdxThunkIdx->u1.AddressOfData);
						pIdxFirstThunk->u1.Function = pScParams->fGetProcAddress(hMod, pName->Name);
					}
				}
			}
		}
...
#ifdef _WIN64
		// Enabling SEH exceptions.
		PIMAGE_DATA_DIRECTORY pExcpDataDir = &pVOptHeader->DataDirectory[IMAGE_DIRECTORY_ENTRY_EXCEPTION];
		if (pExcpDataDir->Size)
		{
			DWORD AmountOfEntries = pExcpDataDir->Size / sizeof(RUNTIME_FUNCTION);

			PRUNTIME_FUNCTION pExcpDir = reinterpret_cast<PRUNTIME_FUNCTION>((BYTE*)pVDosHeader + pExcpDataDir->VirtualAddress);

			pScParams->fRtlAddFunctionTable(pExcpDir, AmountOfEntries, (DWORD64)pVDosHeader);
		}
#endif
